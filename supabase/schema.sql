...
-- A signed-in user can host or participate in only one active game at a time.
-- Guest participants have no user_id and are intentionally excluded.
...
begin
  ...
  -- Clear stale claims before attempting to reserve users for this room.
