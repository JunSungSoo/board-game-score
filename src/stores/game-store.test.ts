...
it('restores the existing static app JSON without losing rounds', () => {
  const old = { gameId: 'skullking', round: 1, roundLabels: [1, 1], skullkingAutoAdvance: false, players: [{ name: 'A', rounds: [10, -20], total: -10 }] };
